...
import { ArrowRight, Send, Sparkles, Users, MessageCircle, Star, Heart, MapPin, Plus, LogOut, Check, Clock } from "lucide-react";
...
function Landing() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero - returning user */}
      {profile ? (
        <section className="relative mx-auto max-w-7xl px-5 pt-12 md:pt-16 pb-10">
